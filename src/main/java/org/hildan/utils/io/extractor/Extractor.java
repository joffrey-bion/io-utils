...
public abstract class Extractor {
     ...
     * @throws IOException
     *             If an I/O error occurs. When this happens, the {@link #reader} is
     *             properly closed before throwing this exception again.
     */
    ...
    /**
     * Extracts the content between the next occurrence of {@code prefix} and the
     ...
     * @return The content between {@code prefix} and {@code suffix}, or {@code null}
     *         if no occurrence is found in the remaining lines of the file.
     * @throws IOException
     *             If an I/O error occurs.
     */
     ...
     *            Whether or not to search the next lines if the prefix and suffix
     *            are not found in the current line.
     * @return The content between {@code prefix} and {@code suffix}, or {@code null}
     *         if no occurrence is found in the remaining lines of the file.
     * @throws IOException
     *             If an I/O error occurs.
     ...
     *         {@code null} if no occurrence of {@code prefix} is found in the
     ...
     *            The {@link String} preceding the part that has to be extracted.
     * @param searchNextLines
     *            Whether or not to search the next lines if the prefix is not found
     *            in the current line.
     * @return The content between {@code prefix} and the end of the line, or
     *         {@code null} if no occurrence of {@code prefix} is found in the
     *         remaining lines of the file.
     ...
     *         {@code null} if {@code prefix} is not found in the current line.
     */
     ...
     *            The {@link String} following the part that has to be extracted.
     * @return The content between {@code prefix} and {@code suffix}, or {@code null}
     *         if one of {@code prefix} and {@code suffix} is not found in the
     *         current line.
     */
